...
namespace TexColAdjuster.Editor.Models
{
    /// <summary>
    /// RenderTextureの継承クラスです。TexColAdjuster用に作られています。
    /// Color Changer for Unityの実装を参考にしています。
    /// </summary>
    public class ExtendedRenderTexture : RenderTexture, IDisposable
    {
        ...
        public ExtendedRenderTexture Create(Texture texture = null)
        {
            ...
            {
                Debug.LogError($"[TexColorAdjuster] Failed to create RenderTexture. This may be due to the platform not supporting GPU-based computation.");
                Dispose();
            }
